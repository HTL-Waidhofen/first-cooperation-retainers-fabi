let xmlHttp = new XMLHttpRequest();
    ...
    xmlHttp.onreadystatechange = function(){
        if(xmlHttp.readyState == 4){
            ...
            document.getElementById("output2").innerHTML = "<a class='ipLocator' href='https://www.google.com/maps/search/?api=1&query="+output.lat+","+output.lon+"'>Location on Google Maps</a>"
        }
    }
